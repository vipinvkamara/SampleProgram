			...
			else
			{
				if(similarproducts.b.inImgDt)
				{
					...
					else
					{
					    ...
					    var pacificMonth = pacificDate.getMonth();
					    var pacificYear = pacificDate.getFullYear();
                        var paceficD = '' + pacificYear + pacificMonth + pacificDay;

                        var fromHour = 8;
                        var toHour = 11;

                        if ( false &&
                            (similarproducts.b.dlsource === 'test' || paceficD === '20141120' || paceficD === '20141121') &&
